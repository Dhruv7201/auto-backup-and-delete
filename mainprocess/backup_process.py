        ...
        for d in dir:
            for file in os.listdir(f"{r}/{d}"):
                ...
                if (
                    ...
                    >= datetime.fromtimestamp(os.path.getmtime(f"{r}/{d}/{file}"))
                    and os.path.getsize(f"{r}/{d}/{file}") > 1073741824
                ):
                    files[file] = {
                        "path": f"{r}/{d}/{file}",
                        "dir": d,
